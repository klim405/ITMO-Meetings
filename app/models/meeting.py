...
from app.models.secondary_tables import meeting_category, meeting_member
...
class Meeting(Base):
    ...
    categories = relationship("Category", secondary=meeting_category, back_populates="meetings")
